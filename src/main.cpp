...
// miner's coin base reward premine -- Premined: 12.000.000
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BlueCoin.com Block";
        CTransaction txNew;
        txNew.nTime = 1513833300;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1513833300;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2285033;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x2999c3f2c59f6926dbccf1c779dfeb7b8de53c69d7839da2e790cd8fdd68f490"));
        block.print();
